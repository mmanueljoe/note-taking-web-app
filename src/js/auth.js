...
export const signup = (email, password) => {
  ...
  if (!saveResult.success) {
    return {
      success: false,
      message:
        saveResult.message || "Failed to create account. Please try again.",
    };
  }
  ...
  if (!authResult.success) {
    return {
      success: false,
      message:
        authResult.message || "Failed to login after signup. Please try again.",
    };
  }
...
export const changePassword = (currentPassword, newPassword) => {
  ...
  if (!saveResult.success) {
    return {
      success: false,
      message:
        saveResult.message || "Failed to change password. Please try again.",
    };
  }
  ...
  if (!authResult.success) {
    return {
      success: false,
      message:
        authResult.message || "Failed to change password. Please try again.",
    };
  }
